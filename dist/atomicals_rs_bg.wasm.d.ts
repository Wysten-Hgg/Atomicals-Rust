...
export const _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hbe6c2cc0abcdbc07: (a: number, b: number) => void;
export const closure233_externref_shim: (a: number, b: number, c: any) => void;
export const closure292_externref_shim: (a: number, b: number, c: any, d: any) => void;
