...
export const _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__ha6c0ae6e289e50fc: (a: number, b: number) => void;
export const closure240_externref_shim: (a: number, b: number, c: any) => void;
export const closure298_externref_shim: (a: number, b: number, c: any, d: any) => void;
