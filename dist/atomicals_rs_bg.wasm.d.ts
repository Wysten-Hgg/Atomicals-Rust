...
export const wasmtransaction_set_sequence: (a: number, b: number) => number;
...
export const __wbg_wasmrealmconfig_free: (a: number, b: number) => void;
export const wasmrealmconfig_new: (a: number, b: number) => number;
export const wasmrealmconfig_name: (a: number) => [number, number];
export const wasmrealmconfig_bitworkc: (a: number) => [number, number];
export const wasmrealmconfig_bitworkr: (a: number) => [number, number];
export const wasmrealmconfig_container: (a: number) => [number, number];
export const wasmrealmconfig_parent: (a: number) => [number, number];
export const wasmrealmconfig_parent_owner: (a: number) => [number, number];
export const wasmrealmconfig_sats_output: (a: number) => bigint;
export const wasmrealmconfig_with_bitworkc: (a: number, b: number, c: number) => number;
export const wasmrealmconfig_with_bitworkr: (a: number, b: number, c: number) => number;
export const wasmrealmconfig_with_container: (a: number, b: number, c: number) => number;
export const wasmrealmconfig_with_parent: (a: number, b: number, c: number, d: number, e: number) => number;
export const wasmrealmconfig_with_sats_output: (a: number, b: bigint) => number;
export const wasmrealmconfig_validate: (a: number) => [number, number];
...
export const atomicalswasm_mint_realm: (a: number, b: number, c: number, d: bigint, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number, n: number, o: number, p: number) => any;
export const atomicalswasm_mint_subrealm: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: bigint, i: number, j: number, k: number, l: number, m: number, n: number, o: number, p: number, q: number, r: number, s: number, t: number, u: number, v: number) => any;
...
export const _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h5655187db0599bb8: (a: number, b: number) => void;
export const closure841_externref_shim: (a: number, b: number, c: any) => void;
export const closure908_externref_shim: (a: number, b: number, c: any, d: any) => void;
